...
✨ About This Repository
This repository contains 5 Java programming projects developed as part of my Java Programming Internship at SAM AI Technologies.
The portfolio demonstrates progression from fundamental Java programming concepts to interactive web interfaces, React-based development, version control, automated deployment, and GitHub Pages hosting.
🎯 Internship Journey
```text
Core Java → Problem Solving → Console Applications
...
---
🚀 Live Project Showcase
#	Project	Java Source	Live Demo
01	🎯 Number Guessing Game	Source	Open Demo
02	🎓 Student Grade Calculator	Source	Open Demo
03	🏧 ATM Interface	Source	Open Demo
04	💱 Currency Converter	Source	Open Demo
05	🔐 Password Generator	Source	Open Demo
🌟 Portfolio Dashboard
🚀 Open the Complete Live Portfolio Dashboard
---
🧩 Projects
01 — 🎯 Number Guessing Game
A console-based Java game where the program generates a random number and the player repeatedly guesses until the correct number is found.
...
---
04 — 💱 Currency Converter
A Java currency conversion application using predefined exchange rates, accompanied by an interactive web interface.
Supported Currencies
USD
INR
EUR
...
Conversion Logic
```text
Source Currency → USD → Target Currency → Result
```
Example: 100 INR ≈ 1.20 USD
Features
Multiple currency support
...
Document
```
The portfolio progressed through:
...
🎯 Skills Demonstrated
Skill	Projects
Java fundamentals	All 5
Problem solving	All 5
Input validation	Grade, ATM, Password
Randomization	Guessing, Password
Loops	Guessing, ATM
Arrays	Grade Calculator
Calculations	Grade, Currency
State handling	ATM
Responsive UI	Web projects
React	ATM
Vite	ATM
...
GitHub Pages deployment
Technical documentation
The final result is a portfolio combining code, interfaces, deployment, and documentation rather than isolated source files.
---
📊 Portfolio Statistics
```text
☕ Java Projects          05
...
---
🌐 Portfolio Dashboard
The dashboard is the central entry point for the project collection.
Includes
Project cards
Project descriptions
Live demo links
...
Professional presentation
🚀 Open Dashboard
Visit Java Mini Projects Dashboard
---
🔗 Quick Links
Live Projects
🎯 Number Guessing Game
...
---
🔮 Future Improvements
The following are potential future enhancements, not current features:
Live currency exchange-rate API
Persistent backend storage
User authentication
Database integration
...
=======
Then navigate to any project's Java version and compile it.
Example:
>>>>>>> 9492290 (Fix dashboard encoding and update README)
```bash
cd "Number guessing game/java version"
...
=======
Or explore the live portfolio:
https://shankar-uxcloud.github.io/Java-mini-projects/
---
🔧 Development Environment
>>>>>>> 9492290 (Fix dashboard encoding and update README)
```text
...
The objective is to make the repository understandable to developers, mentors, recruiters, and reviewers.
---
🎓 Internship Summary
Java Programming Internship — SAM AI Technologies
This repository represents the practical project work completed during the internship.
...
Configured automated deployment using GitHub Actions and GitHub Pages.
Documentation
Created a centralized README and dashboard to communicate the work professionally.
---
💎 Core Takeaways
☕ Java
Strong practice with programming fundamentals and console applications.
